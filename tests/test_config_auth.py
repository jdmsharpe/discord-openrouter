...
def test_default_model_and_cache_ttl_are_applied(monkeypatch):
    ...
    assert auth.DEFAULT_TEXT_MODEL == "deepseek/deepseek-v4-flash"
    assert auth.DEFAULT_IMAGE_MODEL == "google/gemini-3.1-flash-image-preview"
    assert auth.DEFAULT_VIDEO_MODEL == "alibaba/happyhorse-1.1"
